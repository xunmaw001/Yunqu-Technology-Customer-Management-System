                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <label>
                                                标签
                                                <select name="biaoqianTypesSelectSearch" style="width: 100px;" id="biaoqianTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
                                ...
                                <button onclick="graphSex()" type="button" class="btn btn-success 报表">性别统计报表</button>
                                <button onclick="graphDiqu()" type="button" class="btn btn-success 报表">地区统计报表</button>
...
<script>
    ...
    <!-- 本表的查询条件 -->
        ...
        if(sexTypesSelectSearchInput != null){
            ...
            //标签
        var biaoqianTypesSelectSearchInput = document.getElementById("biaoqianTypesSelectSearch");
        if(biaoqianTypesSelectSearchInput != null){
            var biaoqianTypesIndex = biaoqianTypesSelectSearchInput.selectedIndex;
            if( biaoqianTypesIndex  != 0){
                searchForm.biaoqianTypes= document.getElementById("biaoqianTypesSelectSearch").options[biaoqianTypesIndex].value;
            }
        }
                getDataList();
    }
    ...
    function getDataList() {
        http("kehu/page", "GET", {
            ...
            biaoqianTypes: searchForm.biaoqianTypes,
            //级联表的
    ...
    function setDataRow(item, number) {
        ...
        //标签
        var biaoqianTypesCell = document.createElement('td');
        biaoqianTypesCell.innerHTML = item.biaoqianValue;
        row.appendChild(biaoqianTypesCell);
    ...
    //报表
    function graphSex() {
        window.location.href = "graphSex.jsp"
    }

    //报表
    function graphDiqu() {
        window.location.href = "graphDiqu.jsp"
    }
    ...
    //填充本表搜索下拉框
        ...
        function biaoqianTypesSelectSearch() {
            var biaoqianTypesSelectSearch = document.getElementById('biaoqianTypesSelectSearch');
            if(biaoqianTypesSelectSearch != null) {
                biaoqianTypesSelectSearch.add(new Option('-请选择-',''));
                if (biaoqianTypesOptions != null && biaoqianTypesOptions.length > 0){
                    for (var i = 0; i < biaoqianTypesOptions.length; i++) {
                            biaoqianTypesSelectSearch.add(new Option(biaoqianTypesOptions[i].indexName,biaoqianTypesOptions[i].codeIndex));
                    }
                }
            }
        }
